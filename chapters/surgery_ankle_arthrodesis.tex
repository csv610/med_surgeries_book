...
Ankle arthrodesis, commonly referred to as ankle fusion, is a surgical procedure aimed at permanently eliminating motion in the tibiotalar joint, the primary joint of the ankle. This operation is indicated for patients suffering from severe, debilitating pain due to end-stage ankle arthritis or other conditions that compromise joint function. The procedure involves the meticulous removal of the remaining articular cartilage from the distal tibia and the talus, followed by rigid fixation of these bones in a position that optimizes functional alignment. The ultimate goal is to achieve a solid bony union, thereby alleviating pain and restoring stability to the ankle, which is crucial for ambulation and overall quality of life. Ankle arthrodesis is particularly significant in younger, active patients who require a stable platform for weight-bearing activities, despite the inherent loss of joint motion.
...
\begin{itemize}
  ...
  \item Poorly controlled diabetes, neuropathic arthropathy, severe vascular disease, or poor bone quality, which increase risk and require individualized optimization rather than a universal HbA1c threshold.
...
\begin{itemize}
  \item Smoking or nicotine use, which increases nonunion and wound risk; cessation should be strongly supported.
...
Ankle arthrodesis is a well-established option for painful end-stage ankle arthritis after nonoperative treatment has failed. Total ankle replacement is an alternative for selected patients, and the choice depends on deformity, bone and soft-tissue status, activity, comorbidities, and patient goals.

While precise epidemiological data on arthrodesis rates vary by region, it remains a significant surgical option for end-stage ankle disease. Morbidity rates are primarily driven by nonunion, which can range from 5\% to 30\% depending on patient factors (e.g., smoking, diabetes, bone quality) and surgical technique. Other significant morbidities include wound complications (5-15\%) and adjacent joint arthritis (30-50\% long-term). Mortality directly attributable to ankle arthrodesis is exceedingly low, primarily associated with general anesthesia risks in medically complex patients.

The procedure can provide durable pain relief and functional stability for selected patients, but fusion and symptom outcomes vary with technique, alignment, bone and soft-tissue status, smoking, diabetes, and other patient factors; no single success percentage applies to every case. The procedure permanently removes tibiotalar motion, with compensatory motion in the subtalar and midfoot joints.

Functional outcomes include improved walking distance, reduced reliance on assistive devices, and enhanced quality of life, often enabling patients to return to light recreational activities. The long-term prognosis is generally favorable, with the fusion providing a durable solution for pain and stability. However, a significant long-term concern is the development of adjacent joint arthritis, particularly in the subtalar and midfoot joints, due to increased stress and compensatory motion. This can occur in 30-50\% of patients over 10-20 years, potentially requiring further intervention such as subtalar fusion. 

Prognostic factors significantly influencing fusion and long-term outcomes include smoking status, obesity, diabetes, bone quality, alignment, fixation, and surgeon experience. Achieving stable alignment and protecting the soft tissues are crucial. Evidence comes mainly from comparative cohorts, registries, and systematic reviews, and outcomes vary by indication, approach, bone loss, and patient risk factors.
