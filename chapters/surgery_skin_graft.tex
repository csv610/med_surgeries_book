...
\begin{itemize}
  \item \textbf{Absolute Contraindications:}
    \begin{itemize}
      \item \textbf{Active, Uncontrolled Infection:} Infection in the recipient wound bed is a significant contraindication.
      \item \textbf{Inadequate Vascularity of the Recipient Bed:} A poorly vascularized wound bed cannot support graft viability.
      \item \textbf{Uncontrolled Systemic Illness:} Severe medical conditions that preclude safe anesthesia and surgery.
      \item \textbf{Malignancy within the Wound Bed:} Grafting over active malignancy is contraindicated unless for palliative purposes.
    \end{itemize}
...
The outcomes of skin grafting are generally favorable, with high rates of successful graft take when performed on a well-prepared, vascularized wound bed. Success rates for split-thickness grafts range from 70\% to 95\%, while full-thickness grafts may have slightly lower success rates, often exceeding 80\%. Functional outcomes are frequently excellent, restoring the protective skin barrier and facilitating improved mobility.
