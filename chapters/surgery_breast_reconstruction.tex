...
\textbf{Situations requiring multidisciplinary planning, delay, or an alternative plan:}
\begin{itemize}
...
Breast reconstruction can improve body image and quality of life, but outcomes vary by cancer treatment, tissue quality, smoking, comorbidity, reconstructive method, and patient goals. Flap viability, symmetry, complications, sensation, implant longevity, and the need for staged revision should be discussed without presenting a universal success percentage. Reconstruction does not replace oncologic surveillance, which follows the breast-cancer team’s plan.
