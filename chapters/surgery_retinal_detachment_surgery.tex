...
Repair is urgent for most progressive rhegmatogenous detachments, especially when the macula remains attached, but timing is determined by break pattern, macular status, symptoms, duration, and specialist assessment. Scleral buckle, vitrectomy, pneumatic retinopexy, or combined procedures are selected according to retinal anatomy; tractional and exudative detachments require treatment of their underlying cause.
...
\textbf{Situations requiring individualized assessment:}
\begin{itemize}
  ...
  \item Very poor visual potential, advanced proliferative vitreoretinopathy, or longstanding detachment may alter goals and expected benefit, but are not universal absolute contraindications.
  \item Active ocular infection generally requires treatment and a tailored surgical plan.
\end{itemize}
...
Anatomic reattachment is often achievable, but outcomes vary by detachment type, break pattern, proliferative vitreoretinopathy, macular status, duration, and chosen procedure. Anatomic success does not guarantee visual recovery. Macula-on detachments generally have better central-vision potential, whereas macula-off detachments may leave persistent acuity loss or distortion.
