...
Gender-affirming surgery may be part of treatment for gender incongruence or dysphoria when it aligns with the patient's goals and an informed, individualized assessment. It is not automatically preceded by psychotherapy or hormone therapy: requirements vary by procedure, age, health, patient preference, local law, and current professional standards. Hormone therapy can alter anatomy and may affect timing or expectations for some procedures, but it is not a universal prerequisite.
...
\begin{itemize}
  \item \textbf{Psychosocial assessment:} Assess capacity for informed consent, goals, support needs, and co-occurring conditions. The number and type of required assessments or letters varies by procedure, jurisdiction, and applicable standards.
  ...
  \item \textbf{Hormone therapy:} Review current or planned hormone treatment and its relevance to the chosen procedure; a fixed duration is not appropriate for every surgery or patient.
...
\textbf{Factors requiring assessment or optimization:}
\begin{itemize}
  \item A condition that prevents informed consent or makes perioperative care unsafe requires stabilization and a documented support plan.
  \item Active substance use disorder requires treatment and individualized perioperative planning when it compromises safety or adherence.
  \item Expectations that remain incompatible with the likely results require further counseling before proceeding.
...
\begin{itemize}
  \item Active smoking or nicotine use: Increases wound and thrombotic risk; cessation support and individualized perioperative planning are appropriate, without imposing one universal interval for every procedure.
  \item Higher body weight may increase anesthetic, wound, and thrombotic risks for some procedures; counseling and optimization should be individualized rather than based on a universal BMI cutoff.
  ...
  \item Limited practical support: Recovery needs should be assessed and addressed with advance planning; lack of family support alone should not be treated as a categorical contraindication.
  ...
  \item Age and developmental status: Consent, capacity, guardianship, local law, and the individual's goals are assessed in accordance with current multidisciplinary standards; no single psychological evaluation or consent pathway applies in every jurisdiction.
\end{itemize}
...
\begin{enumerate}
  ...
  \item \textbf{Incisions:} Common patterns include double incision with free nipple grafts, periareolar, and keyhole approaches, selected according to skin excess, chest size, and goals.
  \item \textbf{Tissue excision:} Glandular tissue, skin, and fat are reshaped while preserving the pectoralis fascia and relevant neurovascular structures.
  \item \textbf{Nipple--areola management:} The complex may be repositioned as a graft or maintained on a pedicle depending on the approach and anatomy.
  \item \textbf{Hemostasis and drains:} Hemostasis is secured; drains are used selectively according to surgeon and procedure protocol.
  \item \textbf{Closure and dressing:} The wound is closed in layers and dressed, with compression used when appropriate.
\end{enumerate}
...
\begin{enumerate}
  ...
  \item MedlinePlus. Gender Affirming Surgery. U.S. National Library of Medicine; 2024. Available from: \url{https://medlineplus.gov/genderaffirmingsurgery.html}
  \item Hage JJ, et al. Gender-Affirming Surgery: Principles and Practice. Thieme; 2020.
  \item American Society of Plastic Surgeons. Gender Confirmation Surgery. Available from: \url{https://www.plasticsurgery.org/reconstructive-procedures/gender-confirmation-surgery}
\end{enumerate}
