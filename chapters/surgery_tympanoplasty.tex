...
**Situations requiring treatment, counseling, or a modified approach:**

\begin{itemize}
  \item Active, uncontrolled purulent middle ear infection or otorrhea (ear discharge) at the time of surgery.
  \item Surgery on an only-hearing ear requires particularly careful counseling about hearing-loss risk but is not automatically prohibited when the expected benefit outweighs alternatives.
...
Tympanoplasty can close a perforation and may improve conductive hearing, but anatomic closure and hearing improvement are separate outcomes. Prognosis depends on perforation size and location, infection, Eustachian-tube function, ossicular integrity, cholesteatoma, smoking, and revision status. Persistent perforation, hearing loss, tinnitus, vertigo, facial-nerve injury, cholesteatoma, and revision surgery remain possible; no universal graft-take or hearing-success percentage applies.
