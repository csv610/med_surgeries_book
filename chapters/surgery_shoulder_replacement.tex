...
**Situations requiring treatment, optimization, or a different implant strategy:**
\begin{itemize}
  ...
  \item Deltoid paralysis or severe dysfunction is a major limitation for reverse arthroplasty; bone loss, neuropathic arthropathy, and soft-tissue deficiency require individualized reconstruction or salvage planning.
  \item Progressive neurologic disease or uncontrolled systemic illness may make risks outweigh benefits and requires multidisciplinary assessment.
\end{itemize}
...
Shoulder arthroplasty often improves pain and function in appropriately selected patients, but results differ between anatomic and reverse designs and depend on cuff integrity, deltoid function, glenoid and humeral bone stock, diagnosis, age, and rehabilitation. There is no universal success or implant-survival percentage. Persistent pain, stiffness, instability, infection, loosening, fracture, cuff failure, and later revision remain possible.
