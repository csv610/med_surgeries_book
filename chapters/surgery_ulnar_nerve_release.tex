...
\begin{itemize}
  ...
  \item **Surgical Landmarks:** The medial epicondyle, cubital tunnel, Osborne ligament, flexor carpi ulnaris heads, and proximal forearm are key references; the medial antebrachial cutaneous nerve branches must be protected.
\end{itemize}
...
Outcomes depend on the severity and duration of compression, motor or sensory deficit, diabetes, cervical or peripheral coexisting disease, and the chosen operation. Simple decompression and transposition are not interchangeable in every patient. Pain and paresthesia may improve before weakness or muscle wasting, and severe or longstanding deficits may be incomplete; recurrence, scar sensitivity, and persistent symptoms remain possible.
