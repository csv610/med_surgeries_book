...
Microdochectomy is a precise, targeted surgical procedure involving the excision of a single, identified breast duct responsible for pathologic nipple discharge. This focused intervention is typically performed within the subareolar breast tissue through a small, cosmetically favorable incision at the edge of the areola. The primary clinical scenario for its application is persistent, spontaneous, and unilateral nipple discharge originating from a single duct, especially when the discharge is bloody, serosanguinous, or clear and watery. It serves a dual purpose: to definitively diagnose the underlying cause of the discharge by providing tissue for histopathological examination, and to therapeutically resolve the bothersome symptom. This procedure is crucial for distinguishing between benign intraductal lesions, such as papillomas, and more concerning pathologies like atypical hyperplasia or rare forms of ductal carcinoma, thereby guiding appropriate subsequent management.
