...
\textbf{Situations generally precluding listing unless reversible or addressed:}
\begin{itemize}
  \item Active malignancy with a prognosis or recurrence risk incompatible with transplantation; prior cancer requires individualized oncology and transplant review rather than a universal five-year rule.
  ...
  \item Ongoing smoking, untreated substance-use disorder, or demonstrated inability to adhere to care despite assessment and support; abstinence requirements vary by center.
...
Lung transplantation can improve survival and quality of life for carefully selected patients, but outcomes vary by disease, age, frailty, donor and recipient factors, graft function, infection, primary graft dysfunction, and chronic lung allograft dysfunction. Exercise capacity and dyspnea often improve, while lifelong immunosuppression and surveillance are required. Chronic rejection and infection remain important causes of late morbidity and mortality; current registry estimates should be consulted rather than presenting a single universal survival or rejection percentage.
