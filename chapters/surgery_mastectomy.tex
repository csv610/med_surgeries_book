...
\begin{itemize}
  ...
  \item **3. Axillary Staging (if indicated):** If indicated for invasive cancer, a sentinel lymph node biopsy (SLNB) is performed by injecting a radioactive tracer and/or blue dye around the tumor or in the periareolar region. A gamma probe and visual inspection are used to identify and remove the first draining lymph nodes in the axilla. If these nodes are positive for malignancy on intraoperative frozen section or if there is clinical evidence of extensive nodal involvement, a formal axillary lymph node dissection (ALND) may be performed, meticulously removing lymph nodes from levels I and II of the axilla while preserving vital neurovascular structures such as the long thoracic and thoracodorsal nerves.
...
\begin{itemize}
  \item Uncontrolled systemic infection or sepsis, which must be resolved prior to elective surgery due to high risk of surgical site infection and systemic complications.
