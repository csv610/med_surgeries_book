...
\textbf{Situations requiring treatment, optimization, or specialist planning:}

\begin{itemize}
  \item Uncontrolled systemic illness or bleeding risk may require medical optimization and coordination with the treating clinician.
  \item Acute spreading infection generally requires urgent dental treatment and source control rather than automatic deferral of extraction.
  \item Antiresorptive therapy, prior jaw radiation, immunosuppression, and complex anatomy require individualized risk assessment; they are not automatic prohibitions.
\end{itemize}
...
\begin{itemize}
  ...
  \item Pregnancy: necessary dental treatment should not be deferred solely because of pregnancy; elective care and sedation are planned with obstetric considerations.
