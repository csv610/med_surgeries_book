...
\begin{itemize}
  ...
  \item Pregnancy generally leads to deferral of elective surgery when safe alternatives exist; urgent disease requires individualized planning.
  \item Suspected malignancy requires oncologic evaluation and a treatment plan rather than routine TMJ surgery.
\end{itemize}
...
TMJ outcomes depend on the diagnosis, pain mechanism, joint damage, occlusion, parafunctional habits, psychological and medical comorbidity, and procedure. Conservative care, physical therapy, medication, arthrocentesis, arthroscopy, open surgery, and total joint replacement have different indications and risks. Pain may persist even when joint mechanics improve, and infection, nerve injury, malocclusion, stiffness, implant failure, and revision may occur; no universal success percentage applies.
