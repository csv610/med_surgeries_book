...
Situations requiring treatment, optimization, or reconsideration include:
...
Surgery may improve pain and function in carefully selected patients with persistent symptoms, but outcomes vary by diagnosis, technique, coexisting pathology, and rehabilitation. Most patients should first receive appropriate nonoperative care, and there is no universal success percentage; persistent pain, stiffness, nerve symptoms, or recurrence remain possible.

Factors influencing outcomes include the extent of tendon degeneration, the adequacy of debridement, and adherence to postoperative rehabilitation. Evidence for surgery in refractory lateral epicondylitis comes from procedure-specific comparative studies and systematic reviews; the decision should follow failure of appropriate non-operative care and shared decision-making.
...
The diagnosis should be confirmed before surgery because lateral elbow pain can arise from cervical radiculopathy, radial tunnel syndrome, intra-articular pathology, posterolateral rotatory instability, osteoarthritis, distal biceps disease, or referred shoulder pain. Examination assesses the site of maximal tenderness, resisted wrist and finger extension, grip strength, range of motion, and neurologic findings. Imaging is selective; ultrasound or MRI may identify tendon tearing or another lesion when the diagnosis is uncertain or surgery is being considered.

Most patients improve with nonoperative care, including activity modification, education, progressive tendon loading, physiotherapy, and treatment of contributing work or sport technique. A corticosteroid injection may provide short-term relief but can have less favorable longer-term outcomes when repeated. Other injections and procedures have variable evidence. Surgery is generally reserved for persistent, function-limiting symptoms after a well-documented course of nonoperative treatment and after the patient understands that improvement is not guaranteed.

The operative options include open, arthroscopic, or percutaneous debridement, with or without repair of the extensor origin. The surgeon should protect the lateral collateral ligament complex, radial nerve and posterior interosseous nerve, and the radiocapitellar joint. Degenerative tendon tissue is removed only to the extent needed, and a repair or anchor may be used when the tendon is detached or substantially deficient. The procedure should not be described as simply removing a pain source, because pain can persist if the diagnosis is wrong or central sensitization and other conditions coexist.

Rehabilitation is staged. Early motion helps prevent elbow stiffness, while lifting and resisted wrist extension are restricted until the tendon and repair have healed. Later therapy restores forearm rotation, grip, and extensor strength, followed by a graded return to work or sport. Persistent swelling, drainage, fever, new finger or wrist weakness, numbness, or loss of motion requires review. Return-to-play decisions should be based on pain, strength, range of motion, task demands, and therapist or surgeon assessment rather than a fixed number of weeks.
