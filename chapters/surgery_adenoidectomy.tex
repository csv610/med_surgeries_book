...
Adenoidectomy is a treatment for selected children with clinically important adenoid hypertrophy or chronic adenoid disease after assessment of the underlying indication. In pediatric obstructive sleep apnea, it may be performed alone when adenoid hypertrophy is the principal obstruction, but adenotonsillectomy or another treatment may be more appropriate when the tonsils are also enlarged. The choice depends on examination, sleep study, age, obesity, and comorbidity, and no single success rate applies to all children.
...
Careful patient selection is paramount for adenoidectomy. Some conditions require specialist assessment, correction, or postponement rather than being treated as universal absolute contraindications.

\textbf{Important contraindications and precautions:}
\begin{itemize}
  \item \textbf{Unrepaired cleft or submucous cleft palate:} Removing the adenoid pad can worsen velopharyngeal insufficiency; palatal assessment and specialist counseling are required.
  \item \textbf{Uncorrected bleeding disorder:} A suspected coagulopathy should be evaluated and managed before elective surgery.
  \item \textbf{Acute respiratory or systemic infection:} Elective surgery may need to be delayed according to anesthetic and clinical assessment.
\end{itemize}

\textbf{Additional precautions:}
\begin{itemize}
  \item \textbf{Velocardiofacial syndrome (22q11.2 deletion syndrome):} Palatal and airway assessment is important because VPI risk may be increased.
...
For obstructive sleep apnea, symptoms and polysomnographic findings often improve after appropriately selected surgery, but residual disease is possible and follow-up is important. In otitis media, benefit depends on age, effusion duration, adenoid size, hearing status, and whether tympanostomy tubes are also used.
