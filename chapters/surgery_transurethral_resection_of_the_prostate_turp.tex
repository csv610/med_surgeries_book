...
**Situations requiring optimization, a different technique, or another diagnosis:**
\begin{itemize}
...
\begin{itemize}
  \item A very large prostate may be better treated with HoLEP, simple prostatectomy, or another size-appropriate technique; prostate size alone is not an absolute contraindication to transurethral surgery.
...
TURP can improve obstruction and lower urinary tract symptoms in appropriately selected men, but outcomes depend on prostate size and anatomy, bladder function, comorbidity, technique, and the presence of infection or other causes of symptoms. Retrograde ejaculation is common, while bleeding, urethral stricture, bladder-neck contracture, incontinence, persistent urgency, erectile dysfunction, and recurrent obstruction remain possible. Alternative procedures may be preferable in some patients; no universal success or reoperation percentage applies.
