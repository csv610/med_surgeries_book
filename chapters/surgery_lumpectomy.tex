...
A lumpectomy, also referred to as breast-conserving surgery (BCS) or wide local excision, is a surgical intervention aimed at removing a malignant tumor from the breast while preserving the majority of the breast tissue and its overall contour. This procedure involves the precise excision of the breast cancer along with a surrounding margin of healthy tissue to ensure the complete removal of all macroscopic and microscopic cancerous cells. Lumpectomy is a cornerstone in the treatment of early-stage breast cancer, typically followed by adjuvant radiation therapy to the remaining breast tissue, significantly reducing the risk of local recurrence. The primary objective is to achieve oncologic control comparable to mastectomy while providing superior cosmetic and psychological outcomes for eligible patients, thereby enhancing their quality of life. This approach is integral to a multidisciplinary treatment plan for breast cancer, which includes surgical, radiation, and medical oncology expertise.
...
The breast is a modified sweat gland located on the anterior chest wall, extending from the second to the sixth rib vertically and from the sternal edge to the mid-axillary line horizontally. It consists of 15-20 lobes of glandular tissue, each draining into a lactiferous duct that opens onto the nipple. These lobes are embedded within a fibrous and adipose stroma, supported by Cooper's ligaments, which attach to the overlying skin and underlying pectoral fascia. The breast is divided into four quadrants (upper outer, upper inner, lower outer, lower inner) and a central subareolar region, with the upper outer quadrant extending into the axilla as the axillary tail of Spence, a common site for breast cancer.

The arterial supply to the breast is primarily from perforating branches of the internal mammary artery (medially), the lateral thoracic artery, and thoracoacromial artery (laterally), as well as intercostal arteries (posteriorly). Venous drainage parallels the arterial supply, emptying into the axillary vein, internal mammary vein, and intercostal veins. Lymphatic drainage is crucial; approximately 75\% of lymph from the breast drains to the axillary lymph nodes (levels I, II, III), with the remaining drainage to the internal mammary nodes, supraclavicular nodes, and contralateral breast. Key nerves in the vicinity include the intercostobrachial nerve (sensory to the medial upper arm) and the long thoracic and thoracodorsal nerves (motor to serratus anterior and latissimus dorsi, respectively), which are at risk during axillary dissection. Surgical landmarks include the nipple-areola complex, inframammary fold, and the palpable border of the pectoralis major muscle.
...
\textbf{Situations requiring mastectomy, neoadjuvant treatment, further assessment, or an alternative plan:}
\begin{itemize}
...
For appropriately selected early-stage breast cancers, breast-conserving surgery followed by appropriate radiation and systemic therapy provides survival comparable to mastectomy; the choice depends on tumor extent, biology, margins, patient preference, and access to radiation. Local recurrence risk is reduced by adjuvant therapy but varies substantially with age, tumor biology, treatment, and follow-up duration, so a single universal percentage is not appropriate.
