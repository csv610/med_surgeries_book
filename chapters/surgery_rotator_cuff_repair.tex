...
\textbf{Situations requiring treatment, optimization, or an alternative reconstruction:}
\begin{itemize}
  ...
  \item Irreparable tears are not repaired with a standard tendon-to-bone repair, but may be managed with nonoperative care, debridement, tendon transfer, superior capsular reconstruction, or arthroplasty depending on symptoms, age, and arthritis:
    \begin{itemize}
    ...
    \end{itemize}
  \item Advanced glenohumeral arthritis may favor arthroplasty or another strategy rather than isolated cuff repair.
  \item Rehabilitation access and ability to follow restrictions should be addressed in shared decision-making, rather than treated as a universal absolute contraindication.
\end{itemize}
...
Pain and function often improve after repair, but structural healing and clinical improvement are not identical. Prognosis depends on tear size and chronicity, tissue quality, fatty infiltration, age, smoking, diabetes, rehabilitation, and coexisting arthritis. Small and medium symptomatic full-thickness tears may improve with either physical therapy or surgery; large, massive, and irreparable tears have more variable results and may require alternative procedures. No single success or re-tear rate applies to all repairs.

Recurrence or re-tear of the repaired tendon remains a significant prognostic factor, with rates varying widely based on tear size, chronicity, tendon retraction, fatty atrophy, age, smoking, diabetes, tissue quality, and rehabilitation. Procedure-specific comparative trials and systematic reviews support repair for selected symptomatic full-thickness tears, while non-operative treatment remains appropriate for many patients. With appropriate selection, technique, and rehabilitation, repair can improve pain and shoulder function, but recovery is prolonged and a structural re-tear may be asymptomatic or may require further treatment.
