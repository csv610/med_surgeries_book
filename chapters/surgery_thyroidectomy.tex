...
Thyroidectomy is used for selected thyroid cancers, suspicious or symptomatic nodules, compressive goiters, and some causes of hyperthyroidism. The extent of surgery is risk- and anatomy-dependent: lobectomy is appropriate for selected low-risk, unilateral differentiated cancers, while total thyroidectomy and nodal surgery are reserved for larger, invasive, bilateral, or higher-risk disease. In hyperthyroidism, surgery is one option alongside antithyroid medication and radioactive iodine, with choice individualized to disease, pregnancy, eye disease, goiter, and patient preference.
...
**Situations requiring treatment, optimization, or a modified plan:**
...
\begin{itemize}
  ...
  \item Pregnancy: Elective surgery is usually deferred; if thyroid surgery is necessary, the second trimester is generally preferred and the decision is individualized.
...
Outcomes depend on the indication, extent of surgery, pathology, surgeon experience, and comorbidity. Surgery can relieve compression or cure selected hyperthyroidism, but cancer recurrence risk and need for radioactive iodine or additional surgery vary by histology and stage. Risks include bleeding, recurrent or superior laryngeal nerve injury, hypocalcemia, hypothyroidism, and need for lifelong surveillance or hormone replacement after total thyroidectomy; no universal survival percentage applies.
