...
Radical prostatectomy is one curative option for selected men with localized or selected locally advanced prostate cancer and sufficient life expectancy to benefit. Active surveillance is standard for many low-risk cancers, while radiotherapy and other management strategies may be appropriate according to risk group, age, comorbidity, urinary function, and patient preference. Surgery is not automatically first-line for every localized cancer.
...
\subsection*{When surgery may not be appropriate}
\begin{itemize}
  \item Distant metastatic disease generally requires a systemic and/or radiotherapy-based treatment strategy; surgery is considered only in selected multidisciplinary contexts.
  ...
  \item Limited life expectancy or major comorbidity may make the harms of surgery outweigh likely oncologic benefit; this is an individualized decision rather than a fixed age rule.
\end{itemize}
...
From an oncologic perspective, PSA is expected to fall to a very low or undetectable level after surgery, but timing and interpretation depend on the assay and clinical context; an undetectable early PSA does not guarantee permanent cancer eradication. Recovery of erectile function is variable and may take many months, often requiring medical assistance.
...
The outcomes of radical prostatectomy are favorable for appropriately selected patients, but cancer control depends on grade group, PSA, stage, margin and nodal status, and the need for additional treatment. No single survival or cure percentage applies to all localized or locally advanced disease.

Biochemical recurrence risk varies with preoperative and pathological findings, and salvage treatment may be considered if PSA rises. Functional outcomes also vary substantially: continence and erectile function depend on age, baseline function, nerve-sparing feasibility, comorbidity, and center experience. Counseling should include possible persistent incontinence, erectile dysfunction, infertility, and adjuvant or salvage therapy.
