...
Anal fistula surgery is a surgical intervention aimed at treating an abnormal epithelialized tract that connects the anal canal or rectum to the perianal skin, a condition known as a fistula-in-ano. This pathological entity typically arises from an infection of the anal glands located at the dentate line, leading to the formation of an anorectal abscess that drains and fails to heal completely. The surgical procedure is designed to eradicate the fistula tract, eliminate associated sepsis, and prevent recurrence while meticulously preserving the integrity of the anal sphincter muscles to maintain fecal continence. The choice of surgical technique is highly individualized, taking into account the complexity of the fistula, its anatomical relationship to the sphincter, and the patient's overall health status, making it a critical component of colorectal surgery.
...
The **ischioanal (ischio-rectal) fossae** are fat-filled spaces lateral to the anal canal, frequently involved in abscess formation and fistula extension. The **pudendal nerve** provides sensory innervation to the perianal skin and motor innervation to the external anal sphincter, making its preservation critical during surgery. The **inferior rectal arteries and veins** supply and drain the anal canal and perianal region, while lymphatic drainage follows the inferior rectal vessels to the inguinal lymph nodes.
...
\textbf{Situations requiring drainage, optimization, or a different strategy:}
\begin{itemize}
  \item An undrained abscess or uncontrolled sepsis requires urgent drainage and source control; it does not prohibit lifesaving surgery.
...
\begin{enumerate}
  ...
  \item \textbf{Fistulotomy (for selected low fistulas):} A lay-open procedure may be appropriate for a simple, low tract with normal continence and minimal sphincter involvement. The amount of sphincter divided must be assessed individually; a universal percentage cutoff is not appropriate.
