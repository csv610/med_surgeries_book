...
Cystectomy is a major surgical procedure involving the complete or partial removal of the urinary bladder. Most commonly, it refers to radical cystectomy, which is the en bloc resection of the entire bladder, often accompanied by removal of adjacent organs and pelvic lymph nodes, primarily performed for muscle-invasive bladder cancer (MIBC). This complex operation necessitates the creation of a new pathway for urine excretion, known as a urinary diversion, to maintain renal function and quality of life. The procedure is a cornerstone in the management of advanced bladder malignancies and select benign conditions, representing a significant intervention with profound implications for patient recovery and long-term care, requiring meticulous planning and execution.

\section*{Alternative Names}
\begin{itemize}
  \item Bladder removal surgery
  \item Radical cystoprostatectomy (for males, when prostate and seminal vesicles are removed)
  \item Anterior pelvic exenteration (for females, when uterus, ovaries, fallopian tubes, and a portion of the vagina are also removed)
  \item Partial cystectomy (for localized, non-invasive tumors or select benign conditions)
  \item Total cystectomy (synonymous with radical cystectomy in many contexts, especially when referring to complete bladder removal)
  \item Cystourethrectomy (if the urethra is also removed, often for extensive urethral involvement or carcinoma in situ)
\end{itemize}

\section*{Relevant Surgical Anatomy}
The urinary bladder is a muscular, distensible sac located in the anterior pelvis, posterior to the pubic symphysis. Its superior surface is covered by peritoneum, while its anterior and lateral surfaces are extraperitoneal. In males, it lies superior to the prostate and anterior to the rectum, with the seminal vesicles and vas deferens situated posterior to its base. In females, it is anterior to the uterus and vagina. The ureters enter the bladder posterolaterally, and the urethra exits inferiorly. Key anatomical relations include the obturator nerves and vessels, external and internal iliac vessels, and the hypogastric nerves, all of which are in close proximity to the bladder and pelvic lymph nodes.

The arterial supply to the bladder is primarily from the superior and inferior vesical arteries, which are branches of the internal iliac arteries. Venous drainage occurs via the vesical venous plexus, which empties into the internal iliac veins. Lymphatic drainage follows the arterial supply, primarily to the external iliac, internal iliac, and obturator lymph nodes, and then to the common iliac and para-aortic nodes. The autonomic nerve supply to the bladder originates from the pelvic splanchnic nerves (parasympathetic) and hypogastric nerves (sympathetic), forming the inferior hypogastric plexus, which is crucial for bladder function and sexual function. Surgical landmarks include the obliterated umbilical arteries, the vas deferens in males, the round ligaments in females, and the ureters as they cross the common iliac vessels.

\section{Surgical Principle \& Rationale}
The fundamental principle of radical cystectomy is the complete extirpation of the bladder and surrounding tissues that may harbor microscopic disease, thereby achieving oncologic control. This involves a wide surgical margin around the tumor and a comprehensive pelvic lymph node dissection (PLND) to remove regional lymph nodes, which are common sites for metastatic spread. In men, this typically includes the prostate and seminal vesicles, while in women, the uterus, ovaries, fallopian tubes, and a portion of the anterior vaginal wall may be removed to ensure adequate oncologic margins, particularly for tumors involving the bladder neck or trigone. The rationale is to remove all gross and microscopic disease to prevent recurrence and improve long-term survival.

Following bladder removal, the primary technical goal is to restore urinary continuity and function through a urinary diversion. The choice of diversion depends on patient factors, renal function, tumor characteristics, and surgeon preference, aiming to minimize complications and optimize quality of life. Common diversion types include the ileal conduit (Bricker conduit), which is an incontinent diversion where urine drains continuously into an external ostomy bag; and orthotopic neobladder reconstruction, where a segment of bowel is fashioned into a bladder substitute and anastomosed to the urethra, allowing for voluntary voiding. Continent cutaneous diversions, which involve an internal reservoir that is catheterized intermittently, are also an option for select patients. The meticulous execution of both the ablative and reconstructive phases is critical for successful outcomes, balancing oncologic efficacy with functional preservation.

\section{History \& Surgical Evolution}
Early attempts at bladder removal date back to the late 19th and early 20th centuries, often with high morbidity and mortality due to the lack of effective urinary diversion techniques. These initial efforts were fraught with complications such as uremia and infection, limiting the procedure's widespread applicability. The modern era of cystectomy began in the mid-20th century, marked by significant advancements in surgical technique and postoperative care.

In 1950, Dr. Eugene Bricker described the ileal conduit, a revolutionary technique that provided a safe and reliable method for urinary diversion, significantly improving the feasibility and outcomes of radical cystectomy. This innovation transformed cystectomy into a viable curative option for bladder cancer. Subsequent decades saw refinements in surgical technique, including extended pelvic lymph node dissections to improve oncologic staging and control, and the development of nerve-sparing techniques to preserve sexual function. The 1980s and 1990s marked the advent and widespread adoption of orthotopic neobladder reconstruction, pioneered by surgeons like Dr. Guido Zincke and Dr. Urs Studer, offering patients the potential for continent, urethral voiding and improved quality of life compared to external stomas. More recently, the integration of minimally invasive techniques, such as laparoscopic and robotic-assisted radical cystectomy, has further evolved the procedure, aiming to reduce surgical morbidity, blood loss, and hospital stay while maintaining oncologic efficacy.
...
\begin{itemize}
  \item Uncontrolled metastatic disease beyond regional lymph nodes, where curative intent is not achievable and palliative measures are more appropriate.
  ...
  \item Severe coagulopathy that cannot be corrected preoperatively, posing an unacceptable risk of hemorrhage.
...
\begin{itemize}
  ...
  \item Significant cognitive impairment or lack of manual dexterity, which may make self-catheterization for continent diversions or complex stoma care challenging, potentially favoring an ileal conduit.
  \item Active infection (e.g., urinary tract infection, pneumonia), which should be treated and resolved prior to elective surgery.
