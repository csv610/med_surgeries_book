...
\subsection*{Situations requiring treatment, counseling, or an alternative approach}
\begin{itemize}
  \item \textbf{Only Hearing Ear:} Surgery on an only-hearing ear requires especially careful counseling about the risk of profound sensorineural hearing loss; it is not an automatic absolute contraindication when potential benefit outweighs alternatives.
  ...
  \item \textbf{Unconfirmed Diagnosis:} Suspected retrocochlear disease or another cause of hearing loss should be evaluated before elective stapes surgery.
...
Stapes surgery often improves the conductive component of hearing in appropriately selected otosclerosis, but results vary with cochlear reserve, disease extent, anatomy, technique, and complications. Hearing aids remain a reasonable alternative. Persistent or recurrent conductive loss, sensorineural hearing loss, vertigo, taste disturbance, tinnitus, prosthesis problems, and the need for revision should be discussed; no single success percentage applies to every patient.
