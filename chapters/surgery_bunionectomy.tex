...
Pain relief and alignment outcomes depend on deformity, procedure selection, joint status, healing, and patient factors; no single success percentage applies to every bunion operation. Patients should be counseled about prolonged swelling, stiffness, recurrence, transfer metatarsalgia, and possible hardware symptoms.
