...
Comprehensive preoperative workup and preparation are essential to optimize patient safety and surgical outcomes for abdominoplasty. Patients should ideally be near a stable, healthy weight; there is no universal duration or BMI cutoff. Smoking and nicotine exposure substantially increase wound-healing and thrombotic risk, so elective surgery should be deferred until cessation has been discussed and an appropriate abstinence interval has been verified by the operating team.
...
\begin{itemize}
  ...
  \item A planned future pregnancy is not an absolute contraindication, but postponing surgery should be discussed because pregnancy may alter the result.
