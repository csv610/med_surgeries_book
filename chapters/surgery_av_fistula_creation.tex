...
AV fistula creation is a common option for permanent vascular access, but it is not automatically first-line for every patient. An individualized ESKD life-plan considers anatomy, expected dialysis timing, comorbidity, life expectancy, maturation likelihood, and patient goals; graft or catheter access may be appropriate when a native fistula is unsuitable or dialysis is imminent.
...
\textbf{Situations requiring an alternative access plan or optimization:}
\begin{itemize}
