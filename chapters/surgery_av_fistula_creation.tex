...
Arteriovenous (AV) fistula creation is a surgical procedure designed to establish a durable, high-flow vascular access for patients requiring long-term hemodialysis due to end-stage renal disease (ESRD). This intervention involves surgically connecting a native artery directly to a native vein, most commonly in the upper extremity, to create a direct arteriovenous communication. The primary objective is to induce "arterialization" of the vein, causing it to dilate, thicken, and mature into a robust conduit capable of withstanding repeated needle punctures necessary for hemodialysis sessions. AV fistulas are considered the gold standard for permanent vascular access due to their superior long-term patency, lower rates of infection, and reduced overall complications compared to synthetic grafts or central venous catheters, significantly improving patient quality of life and survival.
...
The creation of an AV fistula primarily involves the arteries and veins of the upper extremity. Key arterial structures include the radial artery (distal forearm), ulnar artery (distal forearm), and brachial artery (upper arm). These arteries provide the high-pressure inflow necessary for fistula maturation. The most commonly utilized veins are the cephalic vein, which runs superficially along the lateral aspect of the forearm and arm, and the basilic vein, which runs along the medial aspect of the forearm and arm, eventually diving deep in the upper arm to join the brachial veins. The median cubital vein, connecting the cephalic and basilic veins in the antecubital fossa, is also a common site for anastomosis.

Surgical landmarks and considerations include the wrist (for radiocephalic fistulas), the antecubital fossa (for brachiocephalic or median cubital fistulas), and the upper arm (for brachiobasilic fistulas, often requiring transposition). Important nerve relations include the superficial radial nerve near the radial artery at the wrist, the median nerve in the antecubital fossa, and the ulnar nerve along the medial aspect of the upper arm. Careful dissection is paramount to avoid nerve injury. Lymphatic drainage of the upper extremity generally follows the venous system, with superficial lymphatics draining into axillary nodes; surgical dissection should minimize lymphatic disruption to prevent lymphedema. Adequate arterial inflow, patent outflow veins without central stenosis, and suitable vessel diameters are critical for successful fistula formation and maturation.

\section{Surgical Principle \& Rationale}
The fundamental surgical principle underlying AV fistula creation is the establishment of a direct, low-resistance communication between a high-pressure arterial system and a low-pressure venous system. This direct anastomosis subjects the chosen vein to significantly increased arterial pressure and shear stress, initiating a biological process known as venous arterialization. Over a period of weeks to months, the vein undergoes adaptive remodeling, characterized by hypertrophy of its muscular wall, endothelial proliferation, and progressive dilatation. This transformation converts a thin-walled, collapsible vein into a robust, thick-walled conduit capable of withstanding repeated needle punctures and providing the high blood flow rates (typically >600 mL/min) required for efficient hemodialysis.
