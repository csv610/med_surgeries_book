...
\textbf{Factors requiring multidisciplinary risk assessment:}
\begin{itemize}
  \item Absence of a graftable target or a treatment goal that cannot provide meaningful benefit may make CABG inappropriate.
  \item Severe neurologic impairment, active infection, advanced malignancy, coagulopathy, or refusal of blood products require individualized discussion rather than being universal absolute contraindications.
\end{itemize}
