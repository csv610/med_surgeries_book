...
Lateral internal sphincterotomy (LIS) is a surgical procedure designed to alleviate symptoms of chronic anal fissures by partially dividing the internal anal sphincter muscle. It reduces resting sphincter pressure and can promote healing and pain relief. LIS is an effective option for selected chronic fissures after appropriate medical treatment, but continence risk, prior sphincter injury, inflammatory bowel disease, and patient preference must be considered.
...
Lateral internal sphincterotomy is a surgical option for chronic anal fissures that persist despite medical treatment. Acute fissures are generally managed first with stool regulation and other non-operative measures. For chronic disease, the choice among topical therapy, botulinum toxin, advancement flap procedures, and sphincterotomy depends on healing history, continence risk, prior sphincter injury, and patient preference.
...
\textbf{Situations requiring treatment, further assessment, or an alternative approach:}
\begin{itemize}
...
LIS often produces rapid pain relief and fissure healing in appropriately selected patients, but reported outcomes vary with technique, follow-up, fissure characteristics, and baseline continence. Recurrence and continence disturbance remain possible, particularly after excessive sphincter division or in patients with pre-existing sphincter injury. Tailored division and long-term follow-up are important for balancing healing against continence preservation.
