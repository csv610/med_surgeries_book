...
A vasectomy is an elective method of permanent contraception for people who are confident they do not want future biological pregnancies. Counseling should cover permanence, alternatives, possible regret, failure and ectopic-pregnancy implications, chronic scrotal pain, and the fact that sterility is not immediate. It does not prevent sexually transmitted infections.
...
\begin{itemize}
  ...
  \item Patient uncertainty, ambivalence, coercion, or inability to provide informed consent requires delay and patient-centered counseling.
\end{itemize}
