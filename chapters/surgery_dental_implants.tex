...
\textbf{Situations requiring infection control, optimization, or an alternative plan:}
\begin{itemize}
...
\begin{itemize}
  \item Poorly controlled diabetes mellitus may impair healing and requires individualized medical optimization; no universal HbA1c cutoff applies to every patient.
