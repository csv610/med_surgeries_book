...
\begin{itemize}
  ...
  \item **Surgical Landmarks:** The pars plana, limbus, ora serrata, lens, optic nerve, macula, and retinal vascular arcades are the relevant ocular landmarks for vitrectomy.
\end{itemize}
...
\textbf{Situations requiring treatment, modification, or individualized benefit-risk assessment:}
...
\begin{itemize}
  ...
  \item **Poor Visual Potential:** Longstanding detachment, severe optic-nerve atrophy, or extensive retinal damage may limit visual recovery, but surgery may still be indicated for pain control, globe preservation, infection, or prevention of further complications.
...
Outcomes vary substantially by indication. Vitrectomy may restore anatomy or remove media opacity, but visual recovery depends on macular status, optic-nerve and retinal damage, duration of disease, diabetes, and complications. Retinal detachment, macular hole, epiretinal membrane, hemorrhage, infection, and foreign-body cases have different prognoses; no universal anatomical or visual-success percentage applies.
