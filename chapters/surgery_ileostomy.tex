...
An ileostomy is a surgical procedure that creates an opening, known as a stoma, on the surface of the abdomen, through which a segment of the small intestine (specifically the ileum) is brought to the outside. This surgically created stoma allows for the diversion of fecal matter, bypassing the large intestine (colon) and rectum entirely. It is a critical intervention for various gastrointestinal conditions, providing a pathway for the continuous drainage of liquid to semi-liquid stool into an external collection appliance. This procedure can be temporary, allowing a distal bowel segment to heal, or permanent, serving as the definitive method of fecal elimination after removal of the colon and rectum. Its clinical significance lies in its ability to manage severe inflammatory bowel disease, colorectal cancer, and other conditions that necessitate the removal or complete diversion from the lower gastrointestinal tract, thereby alleviating symptoms, preventing complications, and improving quality of life.
...
The ileum is the final and longest segment of the small intestine, extending from the jejunum to the ileocecal valve, where it joins the large intestine. Its primary functions include the absorption of vitamin B12, bile salts, and remaining nutrients. For ileostomy creation, the terminal ileum is typically utilized due to its proximity to the abdominal wall and its relatively consistent mesentery. The ileum receives its arterial supply from the ileal branches of the superior mesenteric artery (SMA), which form a series of arcades within the mesentery, ensuring a robust blood supply. Venous drainage parallels the arterial supply, emptying into the superior mesenteric vein (SMV) and ultimately the hepatic portal system. Lymphatic drainage follows the mesenteric vessels to the superior mesenteric lymph nodes.

When creating the stoma, the abdominal wall anatomy is crucial. The stoma is ideally placed through the rectus abdominis muscle in the right lower quadrant. This muscle provides a muscular corset around the stoma, reducing the risk of parastomal hernia. The layers traversed include the skin, subcutaneous fat, anterior rectus sheath, rectus abdominis muscle, posterior rectus sheath, and peritoneum. Careful attention must be paid to the neurovascular bundles of the abdominal wall, particularly the intercostal nerves (T7-T12) and their accompanying vessels, to minimize nerve injury and subsequent pain or numbness. The chosen stoma site should be away from bony prominences (e.g., anterior superior iliac spine), skin folds, scars, and the beltline to facilitate optimal appliance adherence and patient comfort.

\section{Surgical Principle \& Rationale}
The fundamental principle of an ileostomy is to divert the fecal stream from a diseased or surgically compromised segment of the large bowel, allowing for healing or providing a permanent alternative route for waste elimination. This is achieved by dividing the ileum, typically in its terminal portion, and bringing the proximal end through a surgically created opening (trephine) in the abdominal wall. The exposed segment of ileum is then everted and sutured to the skin, forming a rosebud-like stoma. This eversion technique, often referred to as a Brooke ileostomy, helps to protect the peristomal skin from corrosive digestive enzymes by directing the effluent away from the skin surface and into an external collection appliance.

The rationale for this diversion is multifaceted. In cases of inflammatory bowel disease or colorectal cancer requiring total proctocolectomy, the ileostomy provides a definitive and permanent means of fecal elimination. For conditions like low rectal anastomoses, severe trauma, or perianal sepsis, a temporary diverting ileostomy protects a distal healing site from fecal contamination, thereby reducing the risk of anastomotic leak, infection, and promoting optimal healing. The continuous flow of liquid small-bowel contents into an external appliance prevents accumulation within the bypassed or resected colon and rectum, alleviating symptoms, preventing complications, or facilitating recovery. The distal bowel segment may be removed, oversewn and left in the abdomen (Hartmann's pouch), or brought out as a mucous fistula, depending on the underlying condition and the potential for future reconstruction.

\section{History \& Surgical Evolution}
The concept of diverting the fecal stream has roots in ancient medicine, with early, often desperate, attempts to manage bowel obstruction. However, the modern ileostomy as a planned surgical procedure began to evolve significantly in the early 20th century. Initial attempts were fraught with severe complications, primarily due to excoriation of the peristomal skin from highly enzymatic small bowel effluent and the lack of effective collection devices.

A pivotal advancement was made by Dr. Bryan Brooke in the 1950s, who introduced the eversion technique for ileostomy creation. This "Brooke ileostomy" involved everting the bowel mucosa over the serosa and suturing it to the skin, creating a spout that significantly reduced peristomal skin complications and improved appliance adherence. This technique became the gold standard. Further refinements were made by surgeons like Dr. Rupert Turnbull, who championed the importance of meticulous preoperative stoma site marking by specialized ostomy nurses, recognizing that proper placement was key to long-term patient success and quality of life. The development of modern, adhesive, odor-proof, and discreet ostomy appliances in the latter half of the 20th century, alongside the rise of specialized ostomy nursing care, dramatically improved the quality of life for patients with ileostomies. These innovations transformed the procedure from a last resort with significant morbidity into a manageable and often life-saving intervention, allowing patients to lead active and fulfilling lives.

\section{Clinical Indications}
An ileostomy is indicated for a variety of gastrointestinal conditions, primarily when the large intestine or rectum is diseased, requires removal, or needs to be bypassed for healing.
...
An ileostomy can serve as both a primary and a secondary procedure, depending on the specific clinical context and the underlying pathology. It is considered a primary procedure when it is the definitive surgical intervention for a condition, such as a total proctocolectomy for medically refractory ulcerative colitis or familial adenomatous polyposis. In these scenarios, the entire colon and rectum are removed, and the ileostomy becomes the permanent means of fecal elimination, representing the first and only surgical step for bowel diversion.

Conversely, an ileostomy often functions as a secondary or adjunct procedure. For example, a temporary diverting loop ileostomy is frequently created after a low anterior resection for rectal cancer to protect the newly formed anastomosis from fecal contamination during its initial healing phase. In this context, the ileostomy is a planned, temporary measure, with the explicit intention of subsequent reversal once the anastomosis has healed and its integrity is confirmed. It can also be a salvage procedure in cases of anastomotic leak, severe peritonitis, or uncontrolled sepsis following other abdominal surgeries, where immediate fecal diversion is necessary to control infection, prevent further complications, and stabilize the patient. The decision for primary versus secondary positioning is guided by the urgency of the condition, the extent of disease, and the potential for future bowel reconstruction.
