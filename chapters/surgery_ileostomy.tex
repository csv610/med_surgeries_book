...
\textbf{Situations requiring optimization, alternative diversion, or careful support planning:}
\begin{itemize}
...
Ileostomy can provide effective diversion or facilitate definitive treatment, but outcomes depend on the underlying disease, urgency, hydration, renal function, stoma complications, and whether reversal is feasible. Total proctocolectomy can remove colonic disease in ulcerative colitis, but an ileostomy itself is not a universal measure of disease control. The APPAC trial concerns antibiotic versus appendectomy management of uncomplicated appendicitis and is not evidence for ileostomy creation.
