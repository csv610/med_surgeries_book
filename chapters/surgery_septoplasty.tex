...
Septoplasty may be offered for clinically significant nasal obstruction, recurrent epistaxis, or other selected symptoms when examination identifies a relevant septal deformity and medical management is inadequate or inappropriate. Other contributors, including turbinate hypertrophy, rhinitis, nasal-valve compromise, polyps, and sinus disease, must also be assessed; septoplasty is not indicated for an asymptomatic deviation and is not automatically the first treatment for every nasal complaint.
...
\begin{itemize}
  ...
  \item Active severe nasal or sinus infection should generally be treated before elective surgery, while urgent indications require individualized planning.
...
\begin{itemize}
  \item \textbf{Young Age}: Timing is individualized; selected children with significant obstruction may undergo conservative, growth-preserving septal surgery.
...
Many appropriately selected patients report improved nasal breathing, but outcomes depend on the cause of obstruction and coexisting nasal disease. Septoplasty may not correct turbinate, valve, allergic, or sinus-related symptoms, and persistent obstruction, bleeding, perforation, or recurrent deviation can occur. There is no universal success percentage; outcomes should be measured against the documented presenting problem.
