...
Esophagectomy is a complex surgical procedure that involves the partial or total removal of the esophagus, the muscular tube that connects the throat to the stomach. This surgery is primarily indicated for the treatment of esophageal cancer, which can be either adenocarcinoma or squamous cell carcinoma, but it may also be performed for benign conditions such as severe achalasia or esophageal perforation. The procedure aims to achieve oncologic clearance by excising the tumor along with surrounding lymphatic tissue, thereby reducing the risk of metastasis. Following resection, gastrointestinal continuity is restored by creating a conduit from the stomach or a segment of the colon or jejunum, which is then anastomosed to the remaining esophagus or pharynx. Given the esophagus's deep anatomical location within the mediastinum, adjacent to critical structures such as the heart, lungs, and aorta, esophagectomy is associated with significant physiological stress and requires meticulous surgical technique, comprehensive preoperative optimization, and intensive postoperative care. The ultimate goal is to ensure the patient can resume normal swallowing and maintain adequate nutrition while achieving the best possible oncological outcomes.
...
The fundamental principle of esophagectomy is to achieve a complete en bloc resection of the tumor-bearing esophagus along with its associated regional lymph nodes, aiming for a margin-negative (R0) resection. This approach is crucial to eradicate both the primary tumor and any potential microscopic metastatic disease within the lymphatic basin, thereby maximizing the chance of cure. The rationale for extensive lymphadenectomy is based on the high propensity of esophageal cancers to metastasize early to regional lymph nodes, often distant from the primary tumor.

Following resection, the critical second principle is the restoration of gastrointestinal continuity, most commonly achieved by mobilizing the stomach into the chest or neck to create a gastric conduit. This conduit is then anastomosed to the remaining proximal esophagus or pharynx, allowing the patient to resume oral intake. Technical goals include achieving wide tumor-free margins, performing a thorough and anatomically appropriate lymphadenectomy, ensuring a well-vascularized and tension-free anastomosis to minimize the risk of anastomotic leak, and preserving sufficient conduit length and perfusion to reach the cervical or intrathoracic esophageal remnant.

The history of esophagectomy is marked by significant milestones that reflect the evolution of surgical techniques and the understanding of esophageal cancer. The first successful esophagectomy was performed by Franz Torek in 1913, who resected a cervical esophageal carcinoma and created an external skin tube to connect the cervical esophagus to the stomach, a highly morbid staged procedure. In 1933, Tetsuzo Ohsawa achieved a breakthrough by performing the first successful one-stage intrathoracic esophagectomy with esophagogastric anastomosis for esophageal cancer.

The modern era of esophagectomy was greatly influenced by Ivor Lewis in the 1940s, who popularized a two-stage approach involving a laparotomy for gastric mobilization followed by a right thoracotomy for esophageal resection and intrathoracic anastomosis. In the 1970s, Mark Orringer introduced the transhiatal esophagectomy, which avoided thoracotomy by bluntly dissecting the esophagus from the abdomen and neck, performing a cervical anastomosis. The McKeown (three-field) approach, combining abdominal, thoracic, and cervical incisions with a cervical anastomosis, gained favor for its comprehensive lymphadenectomy and safer cervical anastomosis. More recently, the advent of minimally invasive techniques, including thoracoscopy and laparoscopy, and robotic-assisted surgery has aimed to reduce the morbidity of this extensive operation while maintaining equivalent oncologic outcomes, marking a significant evolution in patient recovery and surgical precision.

Esophagectomy is indicated in the following clinical scenarios:
...
Esophagectomy is a major component of curative treatment for selected localized or locally advanced resectable esophageal cancer after multidisciplinary staging. The perioperative systemic or chemoradiation strategy depends on histology, location, stage, fitness, and current guideline-based pathways; surgery is not appropriate for every patient with esophageal cancer.

For benign esophageal diseases, esophagectomy is almost invariably a secondary or tertiary option, reserved for cases where less invasive endoscopic or medical treatments have failed, or when the disease has progressed to an end-stage condition causing severe symptoms and compromising quality of life. The decision to proceed with esophagectomy is made after comprehensive multidisciplinary evaluation, considering the patient's overall health, tumor characteristics, and the potential for significant morbidity and mortality associated with the procedure.

\section*{Relevant Surgical Anatomy}
The esophagus is a muscular tube approximately 25-30 cm long in adults, extending from the cricoid cartilage at the C6 vertebral level to the cardia of the stomach at the T11 vertebral level. It traverses the neck, superior and posterior mediastinum, and a short segment within the abdomen. The esophageal wall consists of four layers: mucosa, submucosa, muscularis propria (which includes an inner circular and outer longitudinal layer), and adventitia, with no serosa present in most of its length. 

Key anatomical relations include:

\begin{itemize}
  \item Anteriorly, the trachea in the neck and superior mediastinum.
  \item The aortic arch and left main bronchus anteriorly in the mid-thorax.
  \item The pericardium and left atrium more inferiorly.
  \item Posteriorly, the esophagus lies against the vertebral column and thoracic duct.
\end{itemize}

The arterial supply to the esophagus is segmental and variable: the cervical esophagus receives branches from the inferior thyroid arteries; the thoracic esophagus from bronchial arteries, direct aortic branches, and intercostal arteries; and the abdominal esophagus from the left gastric artery and inferior phrenic arteries. Venous drainage parallels the arterial supply, with the cervical esophagus draining into the inferior thyroid veins, the thoracic esophagus into the azygos and hemiazygos veins, and the abdominal esophagus into the left gastric vein, which is part of the portal system. Lymphatic drainage is extensive, including cervical, paratracheal, subcarinal, paraesophageal, celiac, and perigastric lymph nodes. The vagus nerves descend with the esophagus, forming the esophageal plexus and anterior and posterior vagal trunks, which are typically resected during esophagectomy, leading to gastric denervation. The recurrent laryngeal nerves ascend in the tracheoesophageal groove and are at risk of injury during cervical dissection.
...
\begin{itemize}
  ...
  \item \textbf{Cardiopulmonary optimization:} Smoking cessation should be strongly supported, while pulmonary rehabilitation, bronchodilators for chronic obstructive pulmonary disease, and management of cardiac comorbidities are individualized.
...
\begin{enumerate}
  \item **Abdominal Phase (Laparotomy or Laparoscopy):**
    \begin{itemize}
      \item An upper midline incision or laparoscopic ports are placed.
      \item The stomach is fully mobilized, preserving the right gastroepiploic artery and vein as the primary blood supply for the gastric conduit. The left gastric artery and vein are ligated.
      \item A pyloromyotomy or pyloroplasty is often performed to facilitate gastric emptying, as vagal denervation will occur.
      \item Extensive lymphadenectomy of the celiac axis, lesser curvature, and greater curvature nodes is performed.
      \item A feeding jejunostomy tube is typically placed for postoperative enteral nutrition.
    \end{itemize}

  \item **Thoracic Phase (Right Thoracotomy or Thoracoscopy):**
    \begin{itemize}
      \item The patient is repositioned to the left lateral decubitus position.
      \item A right posterolateral thoracotomy or thoracoscopic ports are placed.
      \item The esophagus is dissected from its mediastinal attachments, from the diaphragm up to the thoracic inlet.
      \item Mediastinal lymphadenectomy, including subcarinal, paraesophageal, and paratracheal nodes, is performed.
      \item The esophagus is transected distally above the tumor and proximally at a level determined by tumor extent and oncologic margins.
    \end{itemize}

  \item **Cervical Phase (Left Cervical Incision):**
    \begin{itemize}
      \item The patient is repositioned supine with the neck extended and turned to the right.
      \item A left cervical incision is made along the anterior border of the sternocleidomastoid muscle.
      \item The cervical esophagus is identified and mobilized.
      \item The gastric conduit, prepared during the abdominal phase, is carefully pulled up through the posterior mediastinum (esophageal bed) into the neck.
      \item A tension-free esophagogastric anastomosis is created in the neck, typically end-to-side or end-to-end, using hand-sewn or stapled techniques.
    \end{itemize}

  \item **Closure and Drains:**
    \begin{itemize}
      \item Chest tubes are placed in the thoracic cavity to drain fluid and air.
      \item The abdominal, thoracic, and cervical incisions are closed in layers.
      \item A nasogastric tube is usually left in place for gastric decompression.
    \end{itemize}
\end{enumerate}
