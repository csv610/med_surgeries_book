...
\textbf{Potential contraindications requiring transplant-center assessment:}

\begin{itemize}
  \item Active systemic infection or uncontrolled chronic infection (e.g., osteomyelitis, active tuberculosis).
  \item Severe, fixed pulmonary hypertension that remains unacceptable after optimization can cause acute right-heart failure; thresholds must be interpreted with reversibility testing and center-specific criteria rather than a single universal cutoff.
  ...
  \item Severe irreversible end-organ damage may require combined-organ assessment or may preclude isolated heart transplantation; dialysis alone is not an automatic exclusion.
  \item Active substance use disorder or inability to participate in care requires treatment, assessment, and a documented plan; these factors are not assessed by a single universal rule.
  \item Severe peripheral or cerebrovascular disease that would preclude safe surgery or recovery.
  \item Inability to adhere to immunosuppression or follow-up despite support and intervention may preclude listing; social support needs should be addressed with a practical care plan rather than treated as a categorical exclusion.
\end{itemize}

Relative Contraindications and Precautions:

\begin{itemize}
  \item Advanced age is evaluated with frailty, comorbidities, and physiologic reserve rather than a single age cutoff.
