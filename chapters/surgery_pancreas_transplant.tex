...
\begin{itemize}
  \item Active malignancy or a prior malignancy with recurrence risk incompatible with transplantation; timing is individualized by tumor type and oncology review.
...
\begin{itemize}
  ...
  \item Type 2 diabetes is not automatically excluded, but insulin dependence, cardiovascular risk, insulin resistance, obesity, and expected benefit require particularly careful selection.
