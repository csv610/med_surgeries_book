...
Trapeziectomy is an option for symptomatic thumb CMC osteoarthritis when pain and functional limitation persist despite appropriate nonsurgical care. The choice among trapeziectomy, suspension/interposition variants, arthrodesis, or implant arthroplasty depends on disease stage, joint stability, age, occupation, and surgeon-patient goals; surgery is not indicated for radiographic arthritis without meaningful symptoms.
...
\textbf{Situations requiring optimization, counseling, or an alternative procedure:}
\begin{itemize}
...
Pain and function often improve after trapeziectomy, but recovery is prolonged and grip or pinch strength may not return to pre-arthritic levels. Outcomes vary with adjacent-joint disease, technique, occupation, rehabilitation, and expectations; persistent pain, weakness, stiffness, complex regional pain, sensory symptoms, and metacarpal subsidence can occur. No universal success percentage applies.
