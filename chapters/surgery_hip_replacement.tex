...
\textbf{Factors requiring optimization or alternative treatment:}

\begin{itemize}
  \item Active systemic infection (e.g., sepsis) or active local infection in the hip joint or surrounding tissues.
  \item Severe neurological or neuromuscular disease may limit rehabilitation and implant stability but requires individualized assessment rather than an automatic exclusion.
  \item Skeletal immaturity and Charcot arthropathy require specialist planning; they are not universal absolute contraindications.
  \item Uncontrolled medical comorbidities that pose an unacceptably high anesthetic or surgical risk.
\end{itemize}

Relative risks and precautions include:
...
\begin{itemize}
  ...
  \item Active infection elsewhere in the body should be evaluated and treated when possible before elective implantation.
