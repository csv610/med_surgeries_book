...
Septorhinoplasty may be offered for persistent, functionally important obstruction after examination identifies structural contributors such as septal deviation, turbinate enlargement, or nasal-valve dysfunction. Septoplasty alone, medical treatment, turbinate treatment, or valve reconstruction may be more appropriate depending on the anatomy. Cosmetic rhinoplasty is elective and should follow individualized assessment of goals, airway, health, and expectations.
...
\begin{itemize}
  ...
  \item Active nasal or sinus infection should generally be treated before elective surgery.
  
  \item Unrealistic expectations or suspected body dysmorphic disorder require careful assessment and appropriate support before elective cosmetic surgery.
  
  \item Young age requires individualized consideration; functional obstruction or significant deformity may justify surgery before skeletal maturity in selected patients.
\end{itemize}
...
Final results evolve over many months and can change with aging. Outcomes depend on the preoperative airway and deformity, skin and cartilage characteristics, technique, healing, and patient goals. There is no universal success or revision rate; residual asymmetry, persistent obstruction, contour change, and the possible need for revision should be included in consent.
