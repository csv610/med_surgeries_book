...
Tubal ligation is overwhelmingly considered a primary, elective procedure for permanent contraception. It is typically chosen by individuals who have made a definitive decision to end their childbearing capacity and are seeking the most effective and irreversible method available. It is not generally classified as a "secondary" or "salvage" procedure in the context of treating a failed primary intervention, as it is a first-line choice for permanent sterilization. However, it can be performed as an adjunct to other primary abdominal or pelvic surgeries, such as during a Cesarean section delivery or concurrently with a hysterectomy, to leverage a single anesthetic and recovery period. In such cases, while it is secondary to the primary surgical indication, it remains a primary method of permanent contraception. Its role is to provide a definitive end to fertility, rather than to diagnose or treat an existing condition, making it a planned, primary intervention for reproductive control.
...
\begin{itemize}
  ...
  \item \textbf{Pregnancy Test:} A negative pregnancy test is absolutely critical and must be confirmed immediately prior to the procedure to avoid inadvertently sterilizing a pregnant individual.
...
\begin{itemize}
  ...
  \item Unresolved indecision or coercion: The patient must be fully informed, mentally competent, and freely consenting to the permanent nature of the procedure.
\end{itemize}
