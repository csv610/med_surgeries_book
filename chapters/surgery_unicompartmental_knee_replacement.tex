...
Unicompartmental knee replacement is an option for symptomatic, advanced osteoarthritis confined to one compartment after nonsurgical treatment is inadequate. Candidate selection requires assessment of alignment, range of motion, ligament integrity, symptoms, and the other compartments; total knee replacement may be more appropriate when disease is multicompartmental or the knee is unstable. UKR can offer faster recovery and more natural function in selected patients, but has a higher long-term revision risk than total knee replacement.
...
**Situations requiring treatment, optimization, or an alternative plan:**
...
Appropriately selected patients often have substantial pain and function improvement, but long-term revision risk is higher than for total knee replacement in many datasets. Progression of arthritis, loosening, bearing problems, instability, infection, and persistent pain can lead to revision. Outcomes vary with compartment, implant, alignment, ligament status, age, activity, and surgeon experience; no single survivorship or success percentage applies to all UKR.
