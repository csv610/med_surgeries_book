...
\begin{itemize}
  \item \textbf{Situations requiring further evaluation, optimization, or an alternative plan:}
    \begin{itemize}
  ...
  \item \textbf{Relative Contraindications \& Precautions:}
    \begin{itemize}
      ...
      \item Advanced age may affect risk and expected benefit, but age alone is not an absolute contraindication.
...
DBS can reduce symptoms and improve quality of life in carefully selected patients, but response varies with diagnosis, target, levodopa responsiveness, cognition, disease duration, programming, and rehabilitation. It does not stop disease progression, and no universal percentage of motor or tremor improvement applies.
