...
\textbf{Situations requiring further evaluation, optimization, or an alternative plan:}
\begin{itemize}
...
Many appropriately selected recipients gain improved sound awareness, speech perception, communication, and quality of life, but outcomes vary with age at onset, duration of deafness, auditory nerve and cochlear anatomy, device use, rehabilitation, language environment, and goals. Earlier implantation is associated with better average language outcomes in children, but no universal functional-hearing percentage or guarantee applies.
