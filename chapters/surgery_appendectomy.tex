...
\begin{itemize}
  \item \textbf{Appendiceal Phlegmon or Abscess:} In some cases, particularly with a well-contained appendiceal mass or abscess, initial non-operative management with intravenous antibiotics and percutaneous drainage may be considered, especially if the patient is stable. This is a nuanced decision based on patient stability, imaging findings, and surgeon experience, often followed by an interval appendectomy weeks later.
