...
\begin{itemize}
  \item \textbf{Medical Optimization:}
    \begin{itemize}
      \item \textbf{Glycemic Control:} For diabetic patients, strict control of blood glucose levels (HbA1c <7\%) is paramount to promote wound healing and reduce infection risk.
...
\begin{itemize}
  \item \textbf{Uncontrolled Systemic Sepsis with Multi-organ Failure:} While amputation can be life-saving for localized sepsis, a patient in profound septic shock with multi-organ failure may be too unstable to tolerate the surgical stress. Stabilization of the patient's hemodynamics and organ function is critical before proceeding, if possible.
