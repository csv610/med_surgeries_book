...
\textbf{Factors requiring optimization or postponement:}
\begin{itemize}
  \item Uncontrolled systemic medical conditions that increase surgical risk.
  \item Active infections in the surgical field.
  \item Expectations or psychosocial conditions that prevent informed consent or safe postoperative care require further assessment and support.
  \item Incomplete skeletal growth usually warrants postponement for elective orthognathic surgery, with exceptions based on the deformity and specialist plan.
