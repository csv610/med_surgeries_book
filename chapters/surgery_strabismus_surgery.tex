...
Situations requiring treatment, stabilization, or individualized planning:

\begin{itemize}
  \item Amblyopia does not itself contraindicate alignment surgery, but expectations about visual function should be addressed and amblyopia treated when appropriate.
  \item Active thyroid eye disease or other unstable causes of muscle restriction may require stabilization before elective alignment surgery.
...
Alignment often improves after surgery, but outcomes vary by strabismus type, previous operations, sensory status, eye movements, age, and underlying disease. Residual or recurrent deviation, diplopia, infection, anterior-segment ischemia, and additional surgery are possible; no universal success percentage applies to all patients.
