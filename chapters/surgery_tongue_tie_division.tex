...
Frenotomy or frenuloplasty may be considered only when a restrictive frenulum is clearly associated with a persistent functional problem after skilled assessment and appropriate nonsurgical support. In infants, breastfeeding support and correction of latch or other causes should precede or accompany the decision; anatomic appearance alone is not an indication, and evidence for speech, dental, or other benefits is more limited.
...
\textbf{Situations requiring treatment, optimization, or further assessment:}
\begin{itemize}
...
Some infants and breastfeeding parents report short-term improvement in nipple pain or latch after a carefully selected procedure, but response is variable and does not guarantee improved weight gain. Speech or dental outcomes are not automatic and may require speech therapy or other care; no universal success percentage applies.
