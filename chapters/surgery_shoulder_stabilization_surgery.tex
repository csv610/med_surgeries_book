...
\textbf{Situations requiring treatment, optimization, or a different stabilization strategy:}
\begin{itemize}
  ...
  \item Severe glenohumeral arthritis or major bone loss may require arthroplasty, bone augmentation, or another procedure rather than isolated soft-tissue stabilization.
\end{itemize}
...
Outcomes depend strongly on age, sport, instability direction, bone loss, Hill-Sachs engagement, hyperlaxity, tissue quality, and the selected procedure. Arthroscopic Bankart repair is appropriate for selected patients with limited bone loss, whereas remplissage, Latarjet, or other bone-restoring procedures may be preferable in higher-risk anatomy. Recurrence, stiffness, pain, nerve injury, and hardware or graft complications remain possible; no single success rate applies to all stabilization procedures.

Many patients regain useful motion and stability, but return to collision or overhead sport is variable and should not be guaranteed. Prognosis depends on the underlying lesion, number of prior dislocations, bone loss, patient activity, and adherence to rehabilitation.
