...
VATS is an approach rather than a single operation and is used for selected diagnostic and therapeutic procedures. Minimally invasive resection may be appropriate for early-stage lung cancer, but the extent of resection and open versus minimally invasive route depend on tumor anatomy, pulmonary reserve, prior treatment, and surgeon expertise. Pleural disease, pneumothorax, effusion, biopsy, and mediastinal procedures each require different indications; conversion to thoracotomy may be necessary for safety.
...
\textbf{Situations requiring optimization, an alternative approach, or conversion:}
\begin{itemize}
  ...
  \item Extensive adhesions, tumor invasion, inability to obtain safe exposure, or inability to tolerate one-lung ventilation may require an open approach or another treatment; these are not universal absolute contraindications to all thoracic surgery.
\end{itemize}
...
VATS use and outcomes vary by procedure, center, disease stage, pulmonary reserve, and patient selection. Minimally invasive surgery may reduce pain and length of stay compared with thoracotomy, but bleeding, prolonged air leak, pneumonia, conversion, recurrence, and cardiopulmonary complications remain possible. No universal morbidity, mortality, or utilization percentage applies to all VATS procedures.
