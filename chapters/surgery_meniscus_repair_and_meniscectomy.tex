...
For **meniscal repair**, the goal is to anatomically re-approximate the torn edges of the meniscus and create an optimal biological environment for healing. This approach is indicated for tears located in the vascularized "red zone" or red-white zone, where sufficient blood supply exists to support healing. The technical goals include achieving stable fixation of the torn fragments and restoring the meniscus's anatomical shape and biomechanical functions. Various arthroscopic techniques, such as inside-out, outside-in, or all-inside repair, utilize specialized sutures or bioabsorbable fixation devices.

In cases where the meniscal tear is complex, degenerative, or located in the avascular "white zone," a **partial meniscectomy** is performed. This involves excising only the unstable, symptomatic portion of the torn meniscus, leaving a stable rim of meniscal tissue. The aim is to eliminate mechanical irritation and pain while preserving as much meniscal tissue as possible. Total meniscectomy is rarely performed due to its association with accelerated knee osteoarthritis, highlighting the importance of meniscal preservation.
...
Meniscus repair or meniscectomy is typically a **primary surgical treatment** for symptomatic meniscal tears that have not responded to conservative management. For acute, traumatic tears, especially in younger patients, surgical intervention is often performed early after injury assessment. Timely surgery can prevent further damage to the meniscus and articular cartilage.
...
\begin{itemize}
  ...
  \item Severe, end-stage osteoarthritis of the knee.
