...
\begin{itemize}
  \item **Prematurity or unstable neonate:** Circumcision should be delayed until the infant is medically stable; no universal weight threshold replaces clinical assessment and local policy.
