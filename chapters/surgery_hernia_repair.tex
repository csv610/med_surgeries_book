...
\textbf{Factors requiring optimization or a different operative strategy:}
\begin{itemize}
  \item Active systemic infection or sepsis requires resuscitation and source-control planning; an incarcerated or strangulated hernia may still require urgent operation despite infection risk.
  ...
  \item Patient refusal or inability to provide informed consent requires capacity and shared-decision assessment, except where emergency law permits treatment to prevent serious harm.
\end{itemize}
