...
Salpingo-oophorectomy is primarily considered a first-line surgical treatment for various adnexal pathologies, particularly in cases of ovarian torsion, large symptomatic tumors, or confirmed malignancies. It serves as the primary surgical intervention for risk-reducing procedures in individuals with genetic predispositions to cancer. 
...
\begin{itemize}
  \item McBurney's point: A reference point for the appendix, located one-third of the distance from the anterior superior iliac spine to the umbilicus.
  \item Calot's triangle: Formed by the cystic duct, common hepatic duct, and the inferior border of the liver, important in identifying the cystic artery during laparoscopic procedures.
\end{itemize}
...
\begin{itemize}
  ...
  \item Desire for future fertility, especially if bilateral oophorectomy is considered or if unilateral removal is planned and the contralateral ovary is compromised.
...
For risk-reducing salpingo-oophorectomy, the procedure is highly effective, reducing the risk of ovarian and fallopian tube cancer by over 90\% in high-risk individuals. However, patients undergoing bilateral oophorectomy face the long-term health implications of surgical menopause, necessitating careful management and follow-up.
