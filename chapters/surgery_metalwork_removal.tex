...
Prognostic factors for a successful outcome include a clear correlation between the implant and the pre-operative symptoms, secure fracture healing, complete removal of the relevant hardware, and absence of infection or refracture. Improvement is not guaranteed when pain has another cause; evidence comes mainly from cohort studies and systematic reviews rather than a universal success rate.
