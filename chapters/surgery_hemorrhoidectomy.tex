...
\textbf{Factors requiring optimization or an alternative treatment:}

\begin{itemize}
  \item Severe, uncorrected coagulopathy or bleeding disorders that cannot be safely managed preoperatively.
  
  \item Suspected anal or rectal malignancy requires diagnostic evaluation and oncologic planning rather than routine hemorrhoidectomy.
  
  \item Active Crohn's disease or severe proctitis requires specialist assessment because wound healing and continence risks may be increased.
...
Excisional hemorrhoidectomy is generally reserved for selected patients with symptomatic external hemorrhoids or combined internal and external disease, especially grades III--IV, after appropriate conservative or office-based treatment. Symptoms usually improve, but postoperative pain, bleeding, urinary retention, recurrence, and continence effects vary; no single success rate applies to every technique or grade.
