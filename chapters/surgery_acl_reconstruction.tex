...
Anterior cruciate ligament (ACL) reconstruction is a common orthopedic surgical procedure designed to replace a torn anterior cruciate ligament within the knee joint with a new tendon graft. The ACL is a crucial intra-articular ligament that provides primary restraint to anterior tibial translation and acts as a secondary restraint to rotational forces, thereby maintaining knee stability. A complete tear of the ACL, frequently sustained during high-impact sports activities involving pivoting, cutting, or sudden deceleration, typically results in symptomatic knee instability, episodes of "giving way," and an elevated risk of secondary damage to the menisci and articular cartilage. The primary objective of reconstruction is to re-establish the biomechanical stability of the knee, facilitate a safe return to demanding physical activities and sports, and mitigate the long-term degenerative changes associated with chronic instability in appropriately selected patients.
...
Early attempts at ACL reconstruction in the late 19\textsuperscript{th} and early 20\textsuperscript{th} centuries involved direct repair of the torn ligament or augmentation with local tissues like fascia lata, often with limited success due to poor understanding of biomechanics and inadequate fixation. The modern era of ACL reconstruction began to take shape in the mid-20\textsuperscript{th} century. In the 1960s, Dr. Kenneth Jones pioneered the use of the central third of the patellar tendon with bone blocks for ACL reconstruction, laying the groundwork for the bone-patellar tendon-bone (BTB) autograft technique. The advent of arthroscopic surgery in the 1970s and 1980s, championed by surgeons like Dr. Richard O'Connor and Dr. Lanny Johnson, revolutionized the field, allowing for less invasive procedures, improved visualization, and reduced morbidity compared to traditional open techniques.

Subsequent decades saw significant advancements in graft choices, including the popularization of hamstring tendon autografts (semitendinosus and gracilis) in the 1990s, offering an alternative with potentially less anterior knee pain. Fixation techniques evolved from simple sutures to interference screws, cortical buttons, and cross-pins, providing stronger and more reliable graft incorporation. The understanding of ACL anatomy also progressed, leading to the development of "anatomic" single-bundle and later double-bundle reconstruction techniques, aiming to more closely replicate the native ligament's biomechanics. Contemporary research continues to refine surgical techniques, graft selection, and rehabilitation protocols, with a focus on optimizing outcomes and accelerating safe return to sport.
...
\begin{enumerate}
  ...
  \item Frank RM, Van Eck CF, Brand J, et al. Anatomic ACL Reconstruction: A Cadaveric Study Comparing Double-Bundle and Single-Bundle Techniques. Arthroscopy. 22012;28(10):1479-1487.
