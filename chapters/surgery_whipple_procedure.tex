...
Situations requiring multidisciplinary staging, optimization, an alternative operation, or a palliative plan include:

\begin{itemize}
  \item Distant metastases or major-vessel involvement usually change the oncologic strategy, but resectability and treatment intent are determined by current multidisciplinary staging and tumor-specific protocols.
  \item Severe comorbidity, uncontrolled infection, or poor performance status may make major surgery unsafe until optimized or may favor nonsurgical or palliative treatment.
\end{itemize}
...
Outcomes depend on tumor type and stage, resectability, margin and nodal status, complications, nutritional and functional status, and systemic therapy. Pancreatic adenocarcinoma generally has a less favorable prognosis than some ampullary, duodenal, or distal bile-duct tumors, but survival estimates vary across modern treatment pathways and should not be represented by one fixed median or percentage. Exocrine insufficiency, diabetes, delayed gastric emptying, fistula, recurrence, and need for long-term nutritional and oncologic follow-up are important considerations.

Periampullary histology, margin status, nodal disease, and response to systemic treatment strongly influence recurrence and survival. Quality of life may be acceptable after recovery, but persistent fatigue, altered digestion, exocrine insufficiency, diabetes, weight loss, and cancer recurrence require individualized follow-up.
