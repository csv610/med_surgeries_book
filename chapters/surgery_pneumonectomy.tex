...
\begin{itemize}
  ...
  \item \textbf{Pulmonary Function Testing (PFTs):} Spirometry, lung volumes, diffusion capacity, exercise capacity, and predicted postoperative function are assessed, often with quantitative imaging. No single FEV1 or DLCO cutoff determines operability; cardiopulmonary reserve and multidisciplinary risk assessment guide the decision.
