...
\begin{itemize}
  \item \textbf{Pheochromocytoma:} Establish alpha-adrenergic blockade before adding a beta-blocker for tachycardia; volume and salt repletion and specialist monitoring are also important.
  \item \textbf{Cushing's syndrome:} Optimize blood pressure, glucose, potassium, infection risk, and cortisol excess; plan perioperative glucocorticoid coverage because postoperative adrenal insufficiency may occur.
  \item \textbf{Primary aldosteronism:} Control blood pressure and correct hypokalemia with a mineralocorticoid-receptor antagonist or potassium replacement while definitive treatment is planned.
\end{itemize}
...
\begin{itemize}
  \item Uncontrolled coagulopathy or severe cardiopulmonary disease requires correction or individualized risk assessment before elective surgery.
  \item Widespread metastatic disease requires multidisciplinary assessment; it is not an automatic contraindication when surgery may offer selected oncologic or palliative benefit.
  \item Patient refusal or inability to provide informed consent requires a capacity and surrogate decision-making assessment.
\end{itemize}

\textbf{Relative risks and precautions:}

\begin{itemize}
  \item Very large tumors or suspected local invasion may necessitate an open oncologic approach rather than laparoscopy.
  ...
  \item Inadequate preoperative alpha-blockade in pheochromocytoma substantially increases hemodynamic risk and requires specialist correction before elective surgery.
...
\begin{itemize}
  \item \textbf{Hypertensive crisis or severe hemodynamic instability:} Particularly during pheochromocytoma resection, due to catecholamine release on manipulation, or hypotension after resection.
  \item **Injury to adjacent organs:**
    ...
    \end{itemize}
  \item \textbf{Adrenal insufficiency:} This may follow bilateral surgery or removal of a hormonally suppressed gland and requires planned glucocorticoid replacement and emergency education.
