...
\begin{itemize}
  ...
  \item Active substance abuse (alcohol or illicit drugs) without a sustained period of abstinence (typically 6 months) and documented rehabilitation, indicating a high risk of non-adherence and recurrence.
  ...
  \item Lack of adequate psychosocial support system, which is vital for long-term adherence and coping.
\end{itemize}
...
The outcomes of liver transplantation have dramatically improved since its inception, transforming a once fatal diagnosis into a treatable condition with excellent long-term survival rates. Current one-year patient survival rates typically range from 85\% to 90\%, with five-year survival rates between 70\% and 75\%. Graft survival rates are slightly lower due to re-transplantation for graft failure. Prognostic factors influencing outcomes include the recipient's pre-transplant medical condition (e.g., MELD score, which predicts short-term mortality), the presence of significant comorbidities (e.g., renal dysfunction, severe cardiac disease), donor organ quality (e.g., steatosis, cold ischemia time), and the occurrence of post-transplant complications such as severe rejection, infection, or vascular thrombosis. Recurrence of the original liver disease, particularly viral hepatitis or hepatocellular carcinoma (e.g., exceeding Milan criteria), can significantly impact long-term prognosis, necessitating vigilant surveillance and specific therapies. While lifelong immunosuppression is required, most recipients achieve a good quality of life, with many able to return to work and normal daily activities. Landmark clinical trials and registries, such as those maintained by the Organ Procurement and Transplantation Network (OPTN) and the Scientific Registry of Transplant Recipients (SRTR), continuously track and report these outcomes, demonstrating sustained improvements. Advances in surgical techniques, immunosuppressive regimens, and critical care management continue to push the boundaries, offering hope for even better long-term outcomes and reduced morbidity for liver transplant recipients.
