...
\textbf{Situations requiring alternative staging, optimization, or specialist review:}
\begin{itemize}
...
The primary outcome of mediastinoscopy is the provision of a definitive histological diagnosis and mediastinal lymph-node staging. The result helps determine whether surgery, neoadjuvant therapy, or definitive chemoradiation is appropriate; management depends on the complete clinical stage, molecular findings, resectability, and multidisciplinary review. Patients with mediastinal nodal disease generally have a different prognosis and treatment pathway from those without it.
